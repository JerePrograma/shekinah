...
El SHA funcional `f642b76fbcdd55613d09fc908275cd8ecb75cf7b` tiene CI/Pages aprobados y 0024 aplicada y verificada en Preview y Production. No reaplicar migraciones. WEB está abierto; su cuarta prueba quedó rechazada y auditada el 15 de septiembre a las 17:33:37 UTC, sin orden vinculada y con cero solicitudes pendientes. ASSISTED volvió a false después de un smoke bloqueado por autenticación Dux; DIRECT y COMMERCE siguen false. El deployment de cierre terminó a las 17:36:20 UTC. El bloqueo se acreditó en la respuesta Dux `access-duplied.faces` y su aviso de otra sesión, no en el control de Chrome. El próximo acceso debe acreditar el formulario Nuevo Pedido, no sólo el tablero. Luego refrescar el catálogo por el sincronizador existente, verificar readiness, reabrir ASSISTED y completar su reserva/cierre antes de DIRECT y COMMERCE. No hay reservas ni preferencias nuevas que compensar. La frecuencia efectiva del scheduler sigue siendo una incidencia independiente; consultar el [registro actualizado](validation/DIRECT_CHECKOUT_2026-09-15.md).
