...
export type Env = Readonly<{
  ...
  ASSISTED_CHECKOUT_ENABLED?: string;
  ...
  MERCADO_LIBRE_EDITORIAL_ENABLED?: string;
  MERCADO_LIBRE_EDITORIAL_SCHEDULER_SECRET?: string;
  ...
  DIRECT_CHECKOUT_ENABLED?: string;
  DUX_ORDER_PERSONAL_ID?: string;
  DUX_ORDER_CUSTOMER_ID?: string;
