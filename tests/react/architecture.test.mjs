...
test('el contenido y las rutas públicas esenciales están declarados en TypeScript', async () => {
...
test('el build produce HTML prerenderizado, redirecciones y SEO técnico', async () => {
  for (const file of [
    'dist/index.html',
  ...
  assert.match(home, /<h1[^>]*>Encontrá productos naturales sin complicaciones/iu);
