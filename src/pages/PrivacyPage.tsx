import { AnalyticsPrivacyControls } from '../analytics/AnalyticsPrivacyControls';
import { commercePrivacySections } from '../content/commerce-privacy';
    ...
    <section className="page-section section" aria-labelledby="privacy-title">
      <div className="container page-layout">
        ...
        <div className="privacy-grid">
          {[...siteContent.privacy.sections, ...commercePrivacySections].map((section) => (
